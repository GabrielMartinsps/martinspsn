...
// cont listaDeMulheres = listaDePessoas.filter(pessoa => pessoa.sexo === "Feminino")
// console.log(listaDeMulheres)

// *****

// pessoaRs = listaDePessoas.find(pessoa => pessoa.estado === "RS" )
// console.log(pessoaRs)
